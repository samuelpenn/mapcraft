...
public class PlanetDescription {
	...
	private static final String		TEXT_BASE = "uk.org.glendale.worldgen.text.planets.";
	...
	public PlanetDescription(Planet planet) {
		this.planet = planet;
		
		phrases = new Properties();
		addBundle("all");
		addBundle(planet.getType().toString().toLowerCase());
	}
	...
	private String getFullDescription(String rootKey) {
		...
		Iterator<PlanetFeature>	features = planet.getFeatureCodes().iterator();
