...
public class StarAPI {
	...
	private static double getSolarConstant(Star star) {
		...
		constant = (1.0 * star.getSpectralType().getSurfaceTemperature() / SpectralType.G2.getSurfaceTemperature());
	 ...
	 */
	public long getOrbitPeriod(Star star, int distance) {
		long		seconds = 0;
		double		mass = star.getSpectralType().getMass();		// Relative to the mass of our sun.
