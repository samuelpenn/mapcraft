 ...
 * @author Samuel Penn.
 */
public class SubJovian extends WorldBuilder {
	public SubJovian() {
		super();
	}
	
	public SubJovian(int width, int height) {
		super(width, height);
	}
	...
	public void generate() {
		Terrain[]	bands = new Terrain[] { Terrain.CreamGas, Terrain.WhiteGas, Terrain.CreamGas,
											...
											Terrain.WhiteGas, Terrain.CreamGas, Terrain.CreamGas,
											Terrain.WhiteGas, Terrain.CreamGas, Terrain.WhiteGas,
											Terrain.WhiteGas, Terrain.CreamGas, Terrain.WhiteGas,
		...
		for (int y=0; y < height; y++) {
			for (int x=0; x < width; x++) {
				...
				int	bandNumber = (y+Die.d6(2)-Die.d6(2))/bandHeight;
