 ...
 * @author Samuel Penn.
 */
public class SuperJovian extends WorldBuilder {
	public SuperJovian() {
		super();
	}
	
	public SuperJovian(int width, int height) {
		super(width, height);
	}
	
	public void generate() {
		Terrain[]	bands = new Terrain[] { Terrain.CreamGas, Terrain.YellowGas, Terrain.WhiteGas,
											Terrain.WhiteGas, Terrain.CreamGas, Terrain.OrangeGas,
											Terrain.RedGas, Terrain.OrangeGas, Terrain.CreamGas,
											Terrain.RedGas, Terrain.CreamGas, Terrain.CreamGas,
											Terrain.WhiteGas, Terrain.RedGas, Terrain.WhiteGas,
