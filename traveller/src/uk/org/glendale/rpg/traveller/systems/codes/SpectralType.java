 ...
 * 'D' stars are White Dwarfs, and use a somewhat different categorisation.
 * Type 'X' stars are X-ray sources, such as neutron stars and black holes.
 * This latter type are completely unofficial, since I can't find the right
 * way to classify these star types.
 * 
 * @author Samuel Penn
 */
public enum SpectralType  {
	...
	public String getRGBColour() {
		...
		switch (getFirst()) {
		case 'D': rgb = "1.0 1.0 1.0"; break;
		case 'X': rgb = "1.0 1.0 1.0"; break;
		case 'Y': rgb = "0.3 0.0 0.0"; break;
		case 'T': rgb = "0.5 0.0 0.0"; break;
		case 'L': rgb = "0.7 0.0 0.0"; break;
		case 'M': rgb = "0.9 0.0 0.0"; break;
		case 'K': rgb = "1.0 0.5 0.0"; break;
		case 'G': rgb = "0.8 1.0 0.0"; break;
		case 'F': rgb = "0.5 1.0 0.2"; break;
		case 'A': rgb = "0.0 1.0 0.5"; break;
		case 'B': rgb = "0.0 1.0 0.7"; break;
		case 'O': rgb = "0.5 1.0 1.0"; break;
		}
	...
	public int getSurfaceTemperature() {
		...
		case 'X':
			...
			k = 1000 + getInverseDigit() * getInverseDigit() * getInverseDigit() * 2000;
			break;
		case 'Y':
			// Ultra-cool brown dwarfs.
			k = getInverseDigit()*60;
			break;
		case 'T':
