...
/**
 * The star class, which is the size of the star. This provides a finer grained
 * indication to the type of star, and can be used to determine how big to draw
 * it on the star map.
 */
public enum StarClass {
	BH("Black Hole", 0.2, 0.0000001), N("Neutron Star", 0.3, 0.000001), D(
			"White Dwarf", 0.5, 0.001), VI("Sub Dwarf", 0.7, 0.5), V(
			"Main Sequence", 1.0, 1.0), IV("Sub Giant", 1.1, 2.0), III("Giant",
			1.2, 10), II("Large Giant", 1.3, 25), Ib("Super Giant", 1.4, 50), Ia(
			"Super Giant", 1.5, 100);
