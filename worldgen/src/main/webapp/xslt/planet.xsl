...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/t:planet">
		<html>
			<head>
				<title>Planet <xsl:value-of select="@name"/></title>
				<link rel="STYLESHEET" type="text/css" media="screen" href="/traveller/data/css/system.css" />
			</head>
			
			<body>
				<h1>Planet <xsl:value-of select="@name"/></h1>
