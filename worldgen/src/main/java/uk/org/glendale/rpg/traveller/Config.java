...
/**
 * Gives access to the configuration options. Configuration is stored in the
 * config.properties found in the uk.org.glendale.cities package.
 * 
 * * @author Samuel Penn
 */
public class Config {
	...
	public static String getBaseUrl() {
		String path = props.getProperty(universe + ".server.url",
				"http://dev.glendale.org.uk/traveller/");
		if (!path.endsWith("/")) {
			path += "/";
		}
		return path;
